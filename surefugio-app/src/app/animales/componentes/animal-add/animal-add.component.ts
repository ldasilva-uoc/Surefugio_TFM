...
export class AnimalAddComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.adopcion = new FormControl('', [Validators.required]);
    this.acogida = new FormControl('', [Validators.required]);
    this.urgente = new FormControl('', [Validators.required]);
    this.vacunado = new FormControl('', [Validators.required]);
    this.desparasitado = new FormControl('', [Validators.required]);
    this.esterilizado = new FormControl('', [Validators.required]);
    this.microchip = new FormControl('', [Validators.required]);
